...
== Installation
  ...
  rake radiant:extensions:fancy_box:install
  
The rake task will run its migrations, add the fancybox js and css, and add a snippet to include in your pages.
...
in the heads of the pages you want fancybox functionality:
  ...
  <r:snippet name="fancy_box_include"/>

Wherever you want an image:
  <r:fancy_img image_id="77"/>
...
tn_geometry - If your version of paperclip supports it, you specify a custom size for the thumnail
  <r:fancy_img image_title="funky_bacon" tn_size="custom" tn_geometry="260x260>" />
